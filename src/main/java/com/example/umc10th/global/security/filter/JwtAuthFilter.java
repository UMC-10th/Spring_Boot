    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (jwtUtil.isValid(token)) {
                ...
                Long memberId = Long.parseLong(jwtUtil.getUid(token));

                // memberId로 회원 조회 → 인증 객체 생성 (일반/OAuth 공통)
                UserDetails member = customUserDetailsService.loadUserById(memberId);
