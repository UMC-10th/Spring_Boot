package com.example.week6_mission.domain.store.service;

import com.example.week6_mission.domain.member.entity.Member;
import com.example.week6_mission.domain.review.entity.Review;
import com.example.week6_mission.domain.store.dto.StoreReqDTO;
import com.example.week6_mission.domain.store.dto.StoreResDTO;
import com.example.week6_mission.domain.store.entity.Store;
import com.example.week6_mission.domain.store.exception.StoreException;
import com.example.week6_mission.domain.store.exception.code.StoreErrorCode;
import com.example.week6_mission.domain.store.repository.StoreRepository;
...
public class StoreService {
    ...
    public StoreResDTO.Review postReview(
        ...
        Store store = storeRepository.findStoreById(Long.parseLong(storeId))
                .orElseThrow(() -> new StoreException(StoreErrorCode.REVIEW_ERROR_CODE));
